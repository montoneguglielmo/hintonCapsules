...
class downSampleCapsuleLayer(nn.Module):
    ...
    def printInfo(self):
        n_params = self.n_inp_caps * (self.dim_inp**2) * self.dim_inp_caps * self.dim_out_caps
        return n_params
...
if __name__ == "__main__":
    ...
    ffw  = fcCapsuleLayer(n_out_caps=10, n_inp_caps=3200, dim_inp_capsules=16, dim_out_capsules=20)
