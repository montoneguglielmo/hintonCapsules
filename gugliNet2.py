...
class netCaps(netClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.lst_modules.append(startCapsuleLayer(dim_out_capsules=8, n_inp_filters=1, n_capsules=32, kernel_size=5, stride=1))
        
        #dimension output 24
        self.lst_modules.append(convCapsuleLayer(n_flt_inp=32, n_flt_out=32, inp_sz=24, dim_inp_caps=8, dim_out_caps=10, flt_sz=2, num_iterations=3))
        
        #dimensions output 12
        self.lst_modules.append(convCapsuleLayer(n_flt_inp=32, n_flt_out=32, inp_sz=12, dim_inp_caps=10, dim_out_caps=12, flt_sz=2, num_iterations=3))

        #dimensions output 6
        self.lst_modules.append(fcCapsuleLayer(n_out_caps=10, n_inp_caps=32 * 6 * 6, dim_inp_capsules=12, dim_out_capsules=16))
