...
class netCaps(netClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.lst_modules.append(downSampleCapsuleLayer(n_inp_caps=32, dim_inp=24, dim_inp_caps=8, dim_out_caps=10, flt_sz=2, num_iterations=3))

        #dimensions output 12

        self.lst_modules.append(downSampleCapsuleLayer(n_inp_caps=32, dim_inp=12, dim_inp_caps=10, dim_out_caps=12, flt_sz=2, num_iterations=3))
